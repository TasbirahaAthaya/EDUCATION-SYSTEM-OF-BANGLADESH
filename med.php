...
WHERE INITCAP(COLLEGE_CATEGORY)='Medical' and INS_NAME like '%".$valueToSearch."%'";
...
BOARD_RESULT,
 ...
 MIN_RESULT_HSC 
 FROM INSTITUTION NATURAL JOIN COLLEGE 
WHERE INITCAP(COLLEGE_CATEGORY)='Medical'";
    $search_result = filterTable($query);
}
...
$numRows = oci_fetch_all($SQL, $results, null, null, OCI_FETCHSTATEMENT_BY_ROW);*/
            ...
            foreach($results as $row)
       {
		   //echo "sdvdg";
			...
			echo  '<td><a href="med_info.php?ins_name='.$row["INS_NAME"].'" class="btn btn-primary btn-lg border-radius">Category</a></td>'; 
            echo "</tr>\n";
