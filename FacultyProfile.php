...
?> 
<ul>
  <li><a class="" href="courseDetails.php?emp_id=<?php echo $username;?>">Course Details</a></li>
  <li><a href="addCourse.php?emp_id=<?php echo $username; ?>">Add Course</a></li>
  <li><a href="courseCreditDetails.php?emp_id=<?php echo $username; ?>">Course Credit Details</a></li>
...
<form  method="post"  name="oracle"  action="oracleFacultyProfile.php">
