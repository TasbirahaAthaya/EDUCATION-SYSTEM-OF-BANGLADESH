...
<?php
$SQL = oci_parse($conn,"SELECT emp_id,emp_name as Name,emp_password as Password,emp_user_name as User_name from EMPLOYEE");
oci_execute($SQL);
...
$numRows = oci_fetch_all($SQL, $results, null, null, OCI_FETCHSTATEMENT_BY_ROW);
            ...
            foreach($results as $row)
       {
			...
			echo  '<td><a href="updateSalary1.php?emp_id='.$row["EMP_ID"].'" class="btn btn-primary btn-lg border-radius">UPDATE/INSERT SALARY</a></td>';
			echo "</tr>\n";
       }
       //echo  '<td><a href="updateSalary1.php?emp_id='.$row["EMP_ID"].'" class="btn btn-primary btn-lg border-radius">UPDATE/INSERT SALARY</a></td>';
