...
$SQL = oci_parse($conn,"SELECT 
  JSC_RESULT,TOTAL_EXAMINEE_JSC,SSC_RESULT,TOTAL_EXAMINEE_SSC,SEC_YEAR
FROM SECONDARY_HISTORY NATURAL JOIN INSTITUTION
WHERE INS_NAME=(select INS_NAME from INSTITUTION where INS_NAME='$ins_name')");
oci_execute($SQL);
