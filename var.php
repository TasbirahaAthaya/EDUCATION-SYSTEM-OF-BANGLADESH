...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT INS_NAME,INS_CITY,INS_STREET,INS_SEAT,INS_CONTACT,INS_PRI_PUB,UNI_TYPE,
 OFFERED_DEGREE,
 RANKING_UGC,
...
WHERE INS_PRI_PUB='Public' and UNI_TYPE='Varsity' and INS_NAME like '%".$valueToSearch."%'";
 ...
 ADDMISSION_APP_DEADLINE,
 ADDMISSION_TEST_DEADLINE FROM INSTITUTION NATURAL JOIN UNIVERSITY 
WHERE INS_PRI_PUB='Public' and UNI_TYPE='Varsity'";
    $search_result = filterTable($query);
}
...
$numRows = oci_fetch_all($SQL, $results, null, null, OCI_FETCHSTATEMENT_BY_ROW);*/
            ...
            foreach($results as $row)
       {
		   //echo "sdvdg";
			...
			echo  '<td><a href="var_info.php?ins_name='.$row["INS_NAME"].'" class="btn btn-primary btn-lg border-radius">DEPT</a></td>'; 
            echo "</tr>\n";
