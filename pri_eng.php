...
<form action="pri_eng.php" method="post">
...
WHERE INS_PRI_PUB='PRIVATE' and UNI_TYPE='Engineering'and INS_NAME like '%".$valueToSearch."%'";
 ...
 ADDMISSION_APP_DEADLINE,
 ADDMISSION_TEST_DEADLINE FROM INSTITUTION NATURAL JOIN UNIVERSITY 
WHERE INS_PRI_PUB='PRIVATE' and UNI_TYPE='Engineering'";
    $search_result = filterTable($query);
}
